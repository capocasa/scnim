import
  SC_Endian, SC_Types#, SC_BoundsMacros, Hash

type
  RGen* {.bycopy.} = object
    init*: proc (seed: uint32)
    trand*: proc (): uint32
    irand*: proc (scale: int32): int32
    irand2*: proc (scale: int32): int32
    ilinrand*: proc (scale: int32): int32
    ibilinrand*: proc (scale: int32): int32
    fcoin*: proc (): cfloat
    frand*: proc (): cfloat
    frand2*: proc (): cfloat
    frand0*: proc (): cfloat
    frand8*: proc (): cfloat
    flinrand*: proc (): cfloat
    fbilinrand*: proc (): cfloat
    fsum3rand*: proc (): cfloat
    drand*: proc (): cdouble
    drand2*: proc (scale: cdouble): cdouble
    linrand*: proc (scale: cdouble): cdouble
    bilinrand*: proc (scale: cdouble): cdouble
    exprandrng*: proc (lo: cdouble; hi: cdouble): cdouble
    exprand*: proc (scale: cdouble): cdouble
    biexprand*: proc (scale: cdouble): cdouble
    sum3rand*: proc (scale: cdouble): cdouble
    s1*: uint32
    s2*: uint32
    s3*: uint32                ##  random generator state
